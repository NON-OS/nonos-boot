//! ZeroState Boot→Kernel ABI (stable, self-describing 128-byte block)
//
...
//   0x50  u8  entropy[32]            // seed material (truncate if have 64)
...
pub struct ZeroStateBootInfo {
    ...
    pub entropy: [u8; 32],     // seed 
    pub rtc_utc: [u8; 8],      // optional RTC snapshot 
